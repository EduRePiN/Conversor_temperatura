#Conversor de temperatura con python y tkinter
...
class Aplicacion(ttk.Frame):
    def __init__(self, parent):
        ...
        self.etiqueta_temp_fahrenheit = ttk.Label(parent, text="Temperatura en F: n/a")
    ...
    def convertir_temp(self):
        ...
        self.etiqueta_temp_fahrenheit.config(text=f"Temperatura en F: {temp_fahrenheit}°")
